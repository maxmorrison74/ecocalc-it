...
def generate_sample_jobs():
    """Generates a comprehensive dataset of municipal concorsi, PA contests, and private/remote job openings across Italy."""
    return [
        {
            "id": "conc-mi-01",
        ...
        {
            "id": "conc-ve-09",
            "title": "Bando 8 Agenti di Polizia Locale e Servizi Marittimi",
            "entity": "Comune di Venezia",
            "region": "Veneto",
            "city": "Venezia",
            "type": "Concorso Pubblico",
            "contract": "Tempo Indeterminato",
            ...
            "url": "https://www.inpa.gov.it/",
            "featured": False,
            "summary": "Concorso per agenti di polizia locale con patente nautica per il presidio dei canali e del centro storico."
        },
        {
            "id": "conc-ge-10",
            "title": "Concorso 15 Geometri e Tecnici di Cantiere",
            "entity": "Comune di Genova",
            "region": "Liguria",
            "city": "Genova",
            "type": "Concorso Pubblico",
            "contract": "Tempo Indeterminato",
            ...
            "url": "https://www.inpa.gov.it/",
            "featured": False,
            "summary": "Selezione per diplomati geometri da inserire nel settore lavori pubblici, viabilità e protezione civile."
        },
        {
            "id": "job-mi-11",
